ServerEvents.recipes(event => {
    ...
    ////// Machine Recipe //////
       event.recipes.gtceu.assembly_line('dm_attractor')
        ...
        .stationResearch(b => b.researchStack(Item.of('gtceu:parallel_fusion_reactor_3')).CWUt(2048).EUt(GTValues.VA[GTValues.UEV]))
        .duration(1800)
   ...
   event.recipes.gtceu.dark_matter_attractor('dark_energgy')
        ...
        .chancedOutput(
            '2x qilby_core:tiny_runic_stellarite_dust', 500, 0
        )
        .duration(100)
        .CWUt(3072)
    ...
    event.recipes.gtceu.dark_matter_attractor('runic_stellarite')
        ...
        .itemOutputs(
            '32x qilby_core:runic_stellarite_dust',
        )
        .chancedOutput(
   ...
   event.recipes.gtceu.dark_matter_attractor('stellarite')
        .itemInputs(
            ...
            '4x qilby_core:runic_stellarite_dust',
   ...
   event.recipes.gtceu.dark_matter_attractor('fabric_of_reality')
        ...
        .inputFluids(
            ...
            Fluid.of('gtca:celestial_tungsten_plasma_plasma', 2000),
            Fluid.of('qilby_core:runic_stellarite', 1440)
        )
        .itemOutputs(
