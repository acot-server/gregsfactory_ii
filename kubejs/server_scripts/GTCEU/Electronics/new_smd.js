ServerEvents.recipes( event => {
    ...
    event.recipes.gtceu.assembler('supracausal_smd_resistor')
        .itemInputs(
            ...
            'gtceu:graphene_dust',
            '8x qilby_core:fine_fabric_of_reality_wire'
        )
        .inputFluids(
            Fluid.of('qilby_core:transparent_aluminium', 576)
        )
        .itemOutputs(
            '32x qilby_core:supracausal_smd_resistor'
        )
        .duration(400)
        .EUt(GTValues.VA[GTValues.UEV]/2)
        .cleanroom(CleanroomType.CLEANROOM);
    ...
    event.recipes.gtceu.assembler('supracausal_smd_diode')
        .itemInputs(
            '4x gtceu:infinity_round',
            'gtceu:vanadium_gallium_dust',
            '16x gtceu:fine_elementium_wire'
        )
        .inputFluids(
            Fluid.of('qilby_core:transparent_aluminium', 576)
        )
        .itemOutputs(
            '32x qilby_core:supracausal_smd_diode'
        )
        .duration(400)
        .EUt(GTValues.VA[GTValues.UEV]/2)
        .cleanroom(CleanroomType.CLEANROOM);
    ...
    event.recipes.gtceu.assembler('supracausal_smd_transistor')
        ...
        .itemOutputs(
            '32x qilby_core:supracausal_smd_transistor'
        )
        .duration(400)
        .EUt(GTValues.VA[GTValues.UEV]/2)
        .cleanroom(CleanroomType.CLEANROOM);
    ...
    event.recipes.gtceu.assembler('supracausal_smd_capacitor')
        .itemInputs(
            '4x gtceu:infinity_round',
            '2x gtca:celestial_tungsten_plate',
            'qilby_core:stellarite_foil'
        )
        .inputFluids(
            Fluid.of('qilby_core:transparent_aluminium', 576)
        )
        .itemOutputs(
            '32x qilby_core:supracausal_smd_capacitor'
        )
        .duration(400)
        .EUt(GTValues.VA[GTValues.UEV]/2)
        .cleanroom(CleanroomType.CLEANROOM);
    ...
    event.recipes.gtceu.assembler('supracausal_smd_inductor')
        ...
        .itemOutputs(
            '32x qilby_core:supracausal_smd_inductor'
        )
        .duration(400)
        .EUt(GTValues.VA[GTValues.UEV]/2)
        .cleanroom(CleanroomType.CLEANROOM);
