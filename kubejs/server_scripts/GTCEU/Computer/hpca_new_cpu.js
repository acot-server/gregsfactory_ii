ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('hpca_cpu_mk8')
        ...
        .inputFluids(
            ...
            Fluid.of('gtca:radon_polymer', 8000)
        )
        .itemOutputs(
            'qilby_core:hpca_processor_mk8'
        )
        .stationResearch(b => b.researchStack(Item.of('qilby_core:hpca_processor_mk7')).CWUt(600).EUt(GTValues.VHA[GTValues.UV]))
        .duration(1200)
    ...
    event.recipes.gtceu.assembly_line('hpca_cpu_mk9')
        ...
        .inputFluids(
            ...
            Fluid.of('gtca:radon_polymer', 16000)
        )
        .itemOutputs(
            'qilby_core:hpca_processor_mk9'
        )
        .stationResearch(b => b.researchStack(Item.of('qilby_core:hpca_processor_mk8')).CWUt(2400).EUt(GTValues.VHA[GTValues.UHV]))
        .duration(1200)
    ...
    event.recipes.gtceu.assembly_line('hpca_cpu_mk10')
        ...
        .inputFluids(
            ...
            Fluid.of('gtca:radon_polymer', 32000)
        )
        .itemOutputs(
            'qilby_core:hpca_processor_mk10'
        )
        .stationResearch(b => b.researchStack(Item.of('qilby_core:hpca_processor_mk9')).CWUt(12500).EUt(GTValues.VHA[GTValues.UEV]))
        .duration(1200)
    ...
    event.recipes.gtceu.assembly_line('hpca_cpu_mk11')
        ...
        .inputFluids(
            ...
            Fluid.of('qilby_core:transparent_aluminium', 64000)
        )
        .itemOutputs(
            'qilby_core:hpca_processor_mk11'
        )
        .stationResearch(b => b.researchStack(Item.of('qilby_core:hpca_processor_mk10')).CWUt(50000).EUt(GTValues.VHA[GTValues.UXV]))
        .duration(1200)
        .EUt(GTValues.VA[GTValues.UXV]);


     event.recipes.gtceu.assembly_line('hpca_cpu_mk12')
        .itemInputs(
            '2x qilby_core:hpca_processor_mk11',
            '64x gtceu:highly_advanced_soc',
            '64x gtceu:highly_advanced_soc',
            '64x gtceu:highly_advanced_soc',
            '64x gtceu:advanced_soc',
        ...
        .stationResearch(b => b.researchStack(Item.of('qilby_core:hpca_processor_mk11')).CWUt(50000).EUt(GTValues.VHA[GTValues.OpV]))
        .duration(1200)
